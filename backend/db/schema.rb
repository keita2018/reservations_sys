...
ActiveRecord::Schema[8.0].define(version: 2025_08_09_099777) do
  ...
  create_table "reservations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["canceled"], name: "index_reservations_on_canceled"
    t.index ["reservation_at"], name: "index_reservations_on_reservation_at"
